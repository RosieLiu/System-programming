...
int main(int argc, char *argv[])
{
  ...
  printf("large size alloc \n");
  #ifdef FF
  printf("first fit malloc algorithm. \n");
  #endif
  #ifdef BF
  printf("best fit malloc algorithm. \n");
  #endif
  #ifdef WF
  printf("worst fit malloc algorithm. \n");
  #endif
  ...
  for (i=0; i < NUM_ITEMS; i++) {
    ...
    assert(malloc_items[0][i].address != NULL);
  } //for i
